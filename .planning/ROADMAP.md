...
- [ ] **Phase 1: Ops Docs Match Deployment** - AZURE, RUNBOOK and INCIDENT-RESPONSE describe the Terraform/Key Vault/private-Postgres system as built
...
|-------|----------------|--------|-----------|
| 1. Ops Docs Match Deployment | 2/2 | Needs Review (live rehearsal) | - |
